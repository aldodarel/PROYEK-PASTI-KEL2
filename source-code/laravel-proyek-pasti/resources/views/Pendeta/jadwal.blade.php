                                                ...
                                                <tbody>
                                                    @foreach ($jadwal_ibadah as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="/pendeta/editjadwal/{{ $item['id'] }}"
